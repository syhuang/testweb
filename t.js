...
function SSOController() {
    var a, b = this,
        ...
        h = 3,
        i = null,
        j = "http://login.sina.com.cn/sso/crossdomain.php",
        k = "http://login.sina.com.cn/sso/login.php",
        l = "http://login.sina.com.cn/sso/logout.php",
        m = "http://login.sina.com.cn/sso/updatetgt.php",
        n = "http://login.sina.com.cn/sso/prelogin.php",
    ...
    this.getVersion = function() {
        return "ssologin.js(v1.4.11) 2013-07-11"
    };
    ...
    this.init = function() {
        if (U(arguments[0]) === "object") return F(arguments[0]);
        b.setLoginType(b.loginType);
        var a = window.sinaSSOConfig;
        typeof a != "object" && (a = {});
        var c;
        for (c in a) b[c] = a[c];
        b.entry || (b.entry = b.service);
        b.isUpdateCookieOnLoad && setTimeout(b.name + ".updateCookie()", 1e4);
        b.isCheckLoginState && K(window, "load", function() {
            b.checkLoginState()
        });
        b.allowAutoFoundServerTime && ssoLoginServerTime && b.setServerTime(ssoLoginServerTime);
        b.customInit()
    };
    this.getLoginInfo = function() {
        var a = X("sso_info");
        return a ? bb(sinaSSOEncoder.Cookie.decode(a)) : {}
    };
    ...
    (function() {
        ...
        this.callbackLoginStatus = function(a) {
            b.customLoginCallBack(a);
            i(f, "onComplete", a);
            a && a.result === !0 ? i(f, "onSuccess", a) : i(f, "onFailure", a)
        };
        D = function(a) {
            b.customLogoutCallBack(a);
            i(g, "onComplete", a);
            a && a.result === !0 ? i(g, "onSuccess", a) : i(g, "onFailure", a)
        };
        F = function(a) {
            var d;
            a = a || {};
            ...
            f = h(f, a);
            window[f.name] = window[f.name] || b;
            for (d in f) c.hasOwnProperty(d) || (b[d] = f[d]);
            b.loginExtraQuery = {};
            bc(b.loginExtraQuery, f.loginExtraQuery);
            for (d in e) f.hasOwnProperty(d) && (b.loginExtraQuery[e[d]] = f[d])
        };
        E = function(a) {
            a = a || {};
            F(a);
            b.login(f.username, f.password, f.savestate)
        };
        G = function(a) {
            a = a || {};
            g = bc({}, d);
    ...
    this.login = function(c, d, e) {
        if (U(arguments[0]) === "object") return E(arguments[0]);
        t ? t.clear() : t = new L(b.timeoutEnable);
        t.start(b.loginTimeout, function() {
            t.clear();
        ...
        u = function() {
            if (b.useIframe && (b.setDomain || b.feedBackUrl)) {
                if (b.setDomain) {
                    ...
                    !b.feedBackUrl && b.domain != "sina.com.cn" && (b.feedBackUrl = Y(b.appLoginURL[b.domain], {
                        domain: 1
                    }))
                }
                r = "post";
                ...
                if (!a) {
                    r = "get";
                    b.scriptLoginHttps ? b.setLoginType(b.loginType | w) : b.setLoginType(b.loginType | x);
                    P(c, d, e)
                }
            } else {
                r = "get";
        ...
        v = function() {
            if (b.loginType & y || b.loginType & x) {
                if (b.servertime) {
                    b.nonce || (b.nonce = H(6));
                    u();
                    return !0
    ...
    this.prelogin = function(a, c) {
        var d = location.protocol == "https:" ? n.replace(/^http:/, "https:") : n,
            e = a.username || "";
        e = sinaSSOEncoder.base64.encode($(e));
        delete a.username;
        var f = {
            entry: b.entry,
        ...
        d = Y(d, bc(f, a));
        b.preloginCallBack = function(a) {
            if (a && a.retcode == 0) {
                b.setServerTime(a.servertime);
                b.nonce = a.nonce;
                b.rsaPubkey = a.pubkey;
                b.rsakv = a.rsakv;
                z = a.pcid;
                C = (new Date).getTime() - B - (parseInt(a.exectime, 10) || 0)
            }
    ...
    this.getServerTime = function(a, c) {
        if (b.servertime) {
            typeof c == "function" && c({
                retcode: 0,
    ...
    this.logout = function() {
        try {
            if (U(arguments[0]) === "object") return G(arguments[0]);
            var a = {
                entry: b.getEntry(),
                callback: b.name + ".ssoLogoutCallBack"
            }, c = location.protocol == "https:" ? l.replace(/^http:/, "https:") : l;
            c = Y(c, a);
            M(b.scriptId, c)
        } catch (d) {}
        return !0
    ...
    this.ssoLogoutCallBack = function(a) {
        a.arrURL && b.setCrossDomainUrlList(a);
        b.crossDomainAction("logout", function() {
            D({
                result: !0
            })
        })
    ...
    this.updateCookie = function() {
        try {
            if (b.autoUpdateCookieTime > 5) {
                ...
                c = setTimeout(b.name + ".updateCookie()", b.autoUpdateCookieTime * 1e3)
            }
            var f = b.getCookieExpireTime(),
            ...
            f == null ? h = {
                ...
                retcode: 6110
            } : f - g > b.noActiveTime && (h = {
                retcode: 6111
            });
            if (h.retcode !== a) {
                b.customUpdateCookieCallBack(h);
                return !1
            }
            var i = location.protocol == "https:" ? m.replace(/^http:/, "https:") : m;
            i = Y(i, {
                entry: b.getEntry(),
    ...
    this.callFeedBackUrl = function(c) {
        try {
            var d = {
                callback: b.name + ".feedBackUrlCallBack"
            };
            c.ticket && (d.ticket = c.ticket);
            c.retcode !== a && (d.retcode = c.retcode);
            var e = Y(b.feedBackUrl, d);
            M(b.scriptId, e)
        } catch (f) {}
        return !0
    };
    this.loginCallBack = function(a) {
        try {
            if (b.timeoutEnable && !t.isset()) return;
            t.clear();
            b.loginExtraFlag = {};
            var c = {}, d = a.ticket,
                e = a.uid;
            if (e) {
                ...
                d && (c.ticket = d);
                if (b.feedBackUrl) b.crossDomain ? b.crossDomainAction("login", function() {
                    b.callFeedBackUrl(c)
                }) : b.callFeedBackUrl(c);
                else if (b.crossDomain) {
                    a.crossDomainUrlList && b.setCrossDomainUrlList({
                        retcode: 0,
                        arrURL: a.crossDomainUrlList
                    });
                    b.crossDomainAction("login", function() {
                        if (d && b.appLoginURL[b.domain]) b.appLogin(d, b.domain, b.name + ".callbackLoginStatus");
                        else {
                            c.userinfo = bc(c.userinfo, b.getSinaCookie());
                            b.callbackLoginStatus(c)
                        }
                    })
                } else b.callbackLoginStatus(c)
            } else {
                if (v && a.retcode == "2092" && b.allowAutoFoundServerTimeError) {
                    b.setServerTime(0);
                    b.loginExtraFlag = bc(b.loginExtraFlag, {
    ...
    this.updateCookieCallBack = function(a) {
        a.retcode == 0 ? b.crossDomainAction("update", function() {
            b.customUpdateCookieCallBack(a)
        }) : b.customUpdateCookieCallBack(a)
    };
    this.feedBackUrlCallBack = function(a) {
        if (r != "post" || !b.timeoutEnable || !! t.isset()) {
            t.clear();
            a.errno == "2092" && b.setServerTime(0);
            if (a.errno == "4069") {
                var c = a.reason.split("|");
                a.reason = c[0];
                if (c.length == 2) {
                    a.rurl = c[1];
                    try {
    ...
    this.crossDomainAction = function(a, c) {
        g = setTimeout(b.name + ".crossDomainResult()", h * 1e3);
        typeof c == "function" ? f = c : f = null;
        if (q) {
            b.crossDomainCallBack(q);
            return !1
        }
        var d = b.domain;
        if (a == "update") {
        ...
        M(b.ssoCrossDomainScriptId, i)
    };
    this.checkLoginState = function(a) {
        a ? b.autoLogin(a) : b.autoLogin(function(a) {
            var c = {};
            if (a !== null) {
                var d = {
                    displayname: a.nick,
    ...
    this.autoLogin = function(a, c) {
        if (b.domain == "sina.com.cn") {
            if (X("SUP") === null && X("ALF") !== null) {
                I(a);
                return !0
            }
        } else if (X("SUP") === null && (c || X("SSOLoginState") !== null || X("ALF") !== null)) {
            I(a);
            return !0
        }
        a(b.getSinaCookie());
    ...
    this.appLogin = function(a, c, d) {
        var e = A.savestate ? parseInt((new Date).getTime() / 1e3 + A.savestate * 86400) : 0,
            f = X("ALF") ? X("ALF") : 0,
            g = {
                callback: d,
                ticket: a,
            ...
            i = Y(h, g);
        M(b.scriptId, i, "gb2312");
        return !0
    };
    this.autoLoginCallBack3 = function(a) {
        if (a.retcode != 0) {
            b.autoLoginCallBack2(a);
            return !1
        }
        var c = b.domain == "sina.com.cn" ? "weibo.com" : b.domain;
        b.appLogin(a.ticket, c, b.name + ".autoLoginCallBack2");
        return !0
    };
    this.setLoginType = function(a) {
        var c = location.protocol == "https:" ? b.https : 0;
        c && (b.crossDomain = !1);
        b.loginType = a | c;
        return !0
    };
    this.setServerTime = function(a) {
        ...
        var c = function() {
            if (b.servertime) {
                b.servertime += b.calcServerTimeInterval / 1e3;
                s.start(b.calcServerTimeInterval, c)
            }
        };
        b.servertime = a;
        s.start(b.calcServerTimeInterval, c)
    };
    this.getPinCodeUrl = function(c) {
        c == a && (c = 0);
        z && (b.loginExtraQuery.pcid = z);
        var d = location.protocol == "https:" ? o.replace(/^http:/, "https:") : o;
        return d + "?r=" + Math.floor(Math.random() * 1e8) + "&s=" + c + (z.length > 0 ? "&p=" + z : "")
    };
    this.showPinCode = function(a) {
        b.$(a).src = b.getPinCodeUrl()
    };
    this.isVfValid = function() {
        return b.getSinaCookie(!0).vf != 1
    };
    ...
    var H = function(a) {
        ...
        return c
            ...
            if (b.domain == "sina.com.cn") {
                c.callback = b.name + ".autoLoginCallBack3";
                c.service = "miniblog";
                c.useticket = 1
            } else {
                c.callback = b.name + ".autoLoginCallBack3";
            ...
            var d = location.protocol == "https:" ? k.replace(/^http:/, "https:") : k;
            d = Y(d, c);
            M(b.scriptId, d, "gb2312");
            return !0
        }, J = function(a) {
            var c = null,
                d = null;
            ...
            b.failRedirect && (b.loginExtraQuery.frd = 1);
            e = bc(e, {
                pagerefer: document.referrer || ""
            });
            e = bc(e, b.loginExtraFlag);
            e = bc(e, b.loginExtraQuery);
            e.su = sinaSSOEncoder.base64.encode($(a));
            b.service && (e.service = b.service);
            if (b.loginType & x && b.servertime && sinaSSOEncoder && sinaSSOEncoder.RSAKey) {
            ...
            var g = b.loginType & w ? k.replace(/^http:/, "https:") : k;
            g = Y(g, f);
            M(b.scriptId, g, "gb2312")
        }, Q = function(a, c, d) {
            R(b.loginFrameName);
            var e = S(b.loginFormId),
                f = O(a, c, d);
            f.encoding = "UTF-8";
            b.crossDomain == !1 && (f.crossdomain = 0);
            f.prelt = C;
            if (b.feedBackUrl) {
                f.url = Y(b.feedBackUrl, {
                    framelogin: 1,
                    callback: "parent." + b.name + ".feedBackUrlCallBack"
                });
                f.returntype = "META"
            } else {
                f.callback = "parent." + b.name + ".loginCallBack";
                f.returntype = "IFRAME";
                f.setdomain = b.setDomain ? 1 : 0
            }
            for (var g in b.loginExtraQuery) {
                if (typeof b.loginExtraQuery[g] == "function") continue;
                f[g] = b.loginExtraQuery[g]
            }
            for (var h in f) e.addInput(h, f[h]);
            var i = b.loginType & w ? k.replace(/^http:/, "https:") : k;
            i = Y(i, bc({
                client: b.getClientType()
            }, b.loginExtraFlag));
            e.method = "post";
            e.action = i;
            e.target = b.loginFrameName;
            var j = !0;
            try {
                e.submit()
            } catch (l) {
...
(function() {
    ...
    this.base64 = {
        ...
        decode: function(a, b, c) {
            ...
            if (b != "binnary" && m.exec(a.join(""))) return c == "array" ? [] : "";
            o = 0;
            do {
                i = d(n, a[o++]);
                j = d(n, a[o++]);
    ...
    this.Cookie = {
        decode: function(a) {
            ...
            switch (e) {
                ...
                case "v02":
                    d = sinaSSOEncoder.base64.decode(f, "urlsafe", "array");
                    return b(sinaSSOEncoder.base64.decode(d, "binnary", "array"));
                default:
                    return decodeURIComponent(a)
            }
        }
...
STK.register("common.login.ssobridge", function(a) {
...
STK.pageletM.register("pl.plugin.sso.index", function(a) {
    return a.common.login.ssobridge({
        vsnf: 1,
        hold_login_state: !1,
        cookie_timeout: 0,
        entry: "weibo",
    ...
    return function(c, d) {
        var e, f = function() {
                ...
                verify: function() {
                    ...
                    }, d = c.getAttribute("from");
                    d && (b = a.core.json.merge(b, {
                        from: d
                    }));
...
STK.register("common.setting.password", function(a) {
    ...
    return function(c, d) {
        var e = function(a) {
            ...
            }, k = a.common.setting.control(c, d, {
                evtAct: j,
                check: f
            }),
            l = a.core.obj.sup(k, ["initPars"]);
        k.initPars = function() {
            l.initPars();
...
STK.register("common.setting.nickname", function(a) {
    var b = {
        E01: "",
        E02: "#L{请输入4-24位字符：支持中文、英文、数字、“-”、“_”}",
        E03: "#L{昵称不能全是数字}",
        E04: "#L{请输入4-24位字符：支持中文、英文、数字、“-”、“_”}",
        E05: "#L{请输入4-24位字符：支持中文、英文、数字、“-”、“_”}",
        E06: "#L{请输入昵称}"
    };
    return function(c, d) {
        var e, f = function() {
    ...
    return function(c) {
        var d, e, f, g, h = {
                ...
                bind: function() {
                    ...
                    for (var b in i) g.add(b, "click", i[b])
                },
                show: function(c, d) {
                    d = a.parseParam({
                        el: null,
                    ...
                    if ( !! d.el && !! a.isNode(d.el)) {
                        ...
                        d.layerPos = a.core.json.merge(a.core.dom.position(f.outer), a.core.dom.getSize(f.outer));
...
STK.register("common.form.ssoErrCode", function(a) {
    ...
    return {
        ...
        5024: "#L{请填写正确的微盾动态码}",
        5025: "#L{动态码有误，请重新输入}",
        5: '#L{尚未注册微博，}<a href="http://weibo.com/logout.php?backurl=' + encodeURIComponent("http://weibo.com/signup/signup.php") + '"' + (b ? "" : ' target="_blank"') + ">#L{马上注册}</a>",
    ...
    return function(f, l) {
        var n, o, p, q, r = {}, s, t, u, v, w = {
                ...
                parseDOM: function() {
                    ...
                    a.core.dom.isNode(a.kit.dom.firstChild(f)) || (f.innerHTML = h.MAIN)
                },
                bind: function() {
...
STK.register("common.dialog.login", function(a) {
    var b = {
        FRAME: '<div class="ly_loginleft"><p class="info">#L{已有新浪博客，新浪邮箱帐号，可直接登录}</p><div class="W_login_form" node-type="loginForm"></div><p class="otherlogin"><a target="_blank" href="http://weibo.com/bind/index.php">#L{使用其他帐号登录}</a></p></div><div class="ly_loginright"><p class="p1">#L{还没有开通？}</p><p class="p2">#L{赶快免费注册一个吧！}</p><div><a class="btn_reg" href="' + ($CONFIG && $CONFIG.register_url || "http://weibo.com/signup/signup.php") + '">#L{立即免费注册}</a></div>' + "</div>",
        TITLE: "#L{登录或注册}"
    }, c = a.ui.dialog({
            isHold: !0
        });
...
STK.register("pl.register.email.source.submitBtn", function(a) {
    ...
    return function(c, d) {
        d = a.parseParam({
            loadHtml: '<b class="loading"></b>#L{立即注册}',
            normalHtml: "#L{立即注册}"
        }, d);
...
STK.register("pl.register.email.source.main", function(a) {
    var b = a.common.form.template,
        c = a.common.trans.form,
        d = a.common.trans.account,
        e = a.common.dialog.login,
        f = a.common.layer.ioError,
        g = a.pl.register.email.source.submitBtn;
    return function(d) {
        var f = window.location.host == "www.weibo.com" ? "www.weibo.com" : "weibo.com",
            h = {}, i, j, k, l, m, n = ["email", "password", "nickname", "verifycodereg"],
            o = a.common.form.rejectFake(),
            p, q = {
                ...
                btn_submit: function(b) {
                    ...
                    if (c) {
                        ...
                        var e = a.core.json.merge(b.data, d);
                        p.setLoading();
                        weiboRegController.setPostData(e);
                        e.entry && weiboRegController.setEntry(e.entry);
                ...
                btn_change_nickname: function() {
                    ...
                    c.request("checkform", {
                        ...
                        type: "nickname",
                        value: encodeURIComponent(i.ctls.nickname.value())
                    })
                },
                ...
                selected_nickname: function(b) {
                    i.ctls.nickname.value(b.data.name);
                    i.ctls.nickname.check();
                    i.ctls.nickname.fire();
                    a.core.evt.fireEvent(j.nickname, "blur")
                },
                ...
                nickname: function(a) {
                    if ( !! a.iodata) {
                        j.nickname_panel.style.display = "";
                        var c = [];
                        for (var d = 0, e = a.iodata.length; d < e; d++) c.push({
                            id: "nick_recommend_" + d,
                            name: a.iodata[d]
                        });
                        j.nickname_list.innerHTML = b("nickRecommend", {
                            data: c
                        });
                        i.ctls.nickname.msg.state = !0
                    }
                }
            }, u = {
                init: function() {
                ...
                build: function() {
                    ...
                    for (var b = 0, e, h, k, o = n.length; b < o; b++) {
                        e = n[b];
                        h = j[e];
                        if (j[e] && a.common.setting[e]) {
                            k = a.queryToJson(h.getAttribute("action-data") || "");
                            k.hook = i;
                            k.proxy = c;
                            k.iokey = "checkform";
                            var q = a.common.setting[e](h, k);
                            i.add(e, q)
                        }
                    }
                    l = a.common.setting.textCopy(d);
                    a.common.layer.emailAutocomplete(j.email);
                    m = a.common.setting.jumpStatics({
                        analyticsLink: "http://" + f + "/signup/v5/jumplog?from=email"
                    });
                    p = g(j.btn_submit)
                },
                bind: function() {
                    ...
                    weiboRegController.init({
                        ...
                        callback: function(b) {
                            p.setNormal();
                            if (b.code == "100000") window.location.href = b.href;
                            else {
